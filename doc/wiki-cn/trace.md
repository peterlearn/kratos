...
可以看[zipkin](https://gitlab.com/firerocksg/xy3-kratos/tree/master/pkg/net/trace/zipkin)的协议上报实现，具体使用方式如下：
...
```go
// 忽略其他代码
import "gitlab.com/firerocksg/xy3-kratos/pkg/net/trace/zipkin"
// 忽略其他代码
func main(){
    // 忽略其他代码
